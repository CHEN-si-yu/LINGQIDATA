...
接口名称: 获取主力资金流向总览
请求方式: POST
接口地址: /api/stock/main_fund_flow_overview

接口说明:
获取主力资金流向总览数据。分档口径：小单<5万，中单5万~20万，大单20万~100万，特大单>=100万。查询条件支持仅传(stock_code)或仅传(start_time+end_time)或两者同时传；时间区间为闭区间，start_time=end_time时可查询当天数据。
...
url = "https://data.diemeng.chat/api/stock/main_fund_flow_overview"
headers = {
    "apiKey": "YOUR_API_KEY",
    "Content-Type": "application/json"
}
    ...
    "list": [
      {
        ...
        "pct_change": 0.52,
        "net_amount": 12886.34,
        "net_amount_rate": 3.16,
        "buy_elg_amount": 8421.57,
        "buy_elg_amount_rate": 2.07,
        "buy_lg_amount": 3154.82,
        "buy_lg_amount_rate": 0.77,
        "buy_md_amount": 692.63,
        "buy_md_amount_rate": 0.17,
        "buy_sm_amount": 617.32,
        "buy_sm_amount_rate": 0.15
      }
    ]
  }
}
